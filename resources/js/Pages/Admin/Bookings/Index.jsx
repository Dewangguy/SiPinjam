                ...
                <div className="overflow-hidden rounded bg-white shadow-sm">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Pemohon</th>
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                            {bookings.data.map((b) => (
                                <tr key={b.id}>
                                    <td className="px-4 py-3 text-sm text-gray-700">{b.user?.name}</td>
